...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MntoEstadosCobro))
        ...
        Me.Grid.EntityName = "EstadoCobro"
        Me.Grid.Size = New System.Drawing.Size(448, 421)
        Me.Grid.ViewName = "tbMaestroEstadoCobro"
        '
        'MntoEstadosCobro
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(696, 509)
        Me.EntityName = "EstadoCobro"
        Me.Name = "MntoEstadosCobro"
        Me.ViewName = "tbMaestroEstadoCobro"
    ...
    Private Sub Grid_EditingCell(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.EditingCellEventArgs) Handles Grid.EditingCell
        With Grid
            Select Case e.Column.Key
                Case "IDEstado"
                    If Engine.Length(Grid.Value("IDEstado")) > 0 Then
                        e.Cancel = (.Row <> Grid.newTopRowPosition)
                    End If
                Case "DescEstado"
                    If Grid.GetValue("Sistema") Then e.Cancel = True
            End Select
        End With
    End Sub
