            ...
            If ExpertisApp.GenerateMessage("Se van a desglosar los cobros seleccionados. ¿Desea continuar.?", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = DialogResult.Yes Then
                If LineasCorrectas() Then
                    ...
                    If txtImporteVto.Text <> txtImporteTotal.Text Then
                        If ExpertisApp.GenerateMessage("El Importe del Cobro Inicial no coincide con la suma de los Cobros que se crearán. ¿Desea continuar de todas formas?", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = DialogResult.No Then
                            blnOk = False
                        End If
                    End If
                    If blnOk Then
